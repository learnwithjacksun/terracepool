...
const InstallationsPage: React.FC = () => {
  ...
  return (
    <div className="bg-cream text-warm-text font-body antialiased overflow-x-hidden">
      ...
      <main>
        {/* Hero */}
        <header data-aos="fade-up" className="relative min-h-[85vh] md:min-h-screen flex items-center overflow-hidden pt-24 pb-16">
        ...
        {/* Build Process */}
        <section data-aos="fade-up" className="py-16 md:py-28 bg-milk">
          <div className="max-w-7xl mx-auto px-6 md:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
              {[
                ...
                <div key={step.id} data-aos="fade-up" data-aos-delay={i * 200} className="bg-white rounded-xl md:rounded-2xl p-6 md:p-7 group hover:gold-border transition-all duration-500 warm-shadow">
            ...
            <div className="mt-10 md:mt-12 text-center" data-aos="zoom-in">
        ...
        {/* CTA */}
        <section data-aos="fade-up" className="py-16 md:py-24 px-6 md:px-8 max-w-7xl mx-auto">
